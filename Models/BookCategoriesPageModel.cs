...
namespace Coblis_TudorCristian_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Coblis_TudorCristian_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Coblis_TudorCristian_Lab2Context context,
