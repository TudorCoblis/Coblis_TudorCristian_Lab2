...
namespace Coblis_TudorCristian_Lab2.Data
{
    public class Coblis_TudorCristian_Lab2Context : DbContext
    {
        ...
        public DbSet<Coblis_TudorCristian_Lab2.Models.Category>? Category { get; set; }

        public DbSet<Coblis_TudorCristian_Lab2.Models.Member>? Member { get; set; }

        public DbSet<Coblis_TudorCristian_Lab2.Models.Borrowing>? Borrowing { get; set; }
    }
}
